...
%{
subplot(1,3,1)
surf(-20:k:20,-20:k:20,U(:,:,25));
shading flat
subplot(1,3,2)
surf(-20:k:20,-20:k:20,U(:,:,50));
shading flat
subplot(1,3,3)
surf(-20:k:20,-20:k:20,U(:,:,100));
shading flat
%}
function f_n=f(x)
 k=0.5;
 ...
 for n=2:1:N-1
     for m=2:1:M-1
         f_n(m,n)=(-x(m+1,n)-x(m,n+1)+2*x(m,n))/k;
     end
 end
end
